...
const Navbar = () => {
    ...
    return (
        <nav className="fixed top-8 w-full px-8 z-50 " aria-label="Top">
            <div className="bg-white rounded-xl shadow py-3 px-4 ">
                <div className="flex justify-between ">
                    ...
                    <div className="hidden md:block  py-2 px-4 border border-transparent rounded-md text-gray-700 ">
                        <SearchIcon className="h-5 w-5 cursor-pointer" aria-hidden="true" onClick={() => setIsOpen(!isOpen)}/>
                    </div>
